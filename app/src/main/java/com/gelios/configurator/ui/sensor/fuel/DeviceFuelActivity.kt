package com.gelios.configurator.ui.sensor.fuel
...
import com.gelios.configurator.ui.sensor.fuel.fragments.monitoring.HomeFuelViewModel.Companion.WORKER_TAG
import com.google.android.material.bottomnavigation.BottomNavigationView

class DeviceFuelActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun instance(context: Context, isFirmware: Boolean): Intent {
            val intent = Intent(context, DeviceFuelActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_device_fuel)
