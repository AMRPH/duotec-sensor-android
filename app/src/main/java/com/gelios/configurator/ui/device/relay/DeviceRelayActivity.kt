package com.gelios.configurator.ui.device.relay
...
import com.gelios.configurator.ui.device.relay.fragments.monitoring.HomeRelayViewModel.Companion.WORKER_TAG
import com.google.android.material.bottomnavigation.BottomNavigationView


class DeviceRelayActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun instance(context: Context, isFirmware: Boolean): Intent {
            val intent = Intent(context, DeviceRelayActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_device_relay)
